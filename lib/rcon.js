...
/*
  ...
  Bağlantı bilgileri env değişkenlerinde tutulur (GenPvP için
  RCON_HOST_GENPVP, RCON_PORT_GENPVP, RCON_SIFRE_GENPVP).
*/
...
const SUNUCU_ENV = {
  genpvp: { host: "RCON_HOST_GENPVP", port: "RCON_PORT_GENPVP", sifre: "RCON_SIFRE_GENPVP" },
};
