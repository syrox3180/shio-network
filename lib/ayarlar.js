...
export const PAKETLER = [
  {
    ...
    satinAlLinki: "", // 👉 VIP ürününün Shopier linki
    ayricaliklar: [
  ...
  },
  {
    ...
    satinAlLinki: "", // 👉 MVP ürününün Shopier linki
    devami: "VIP",
  ...
  },
  {
    ...
    satinAlLinki: "", // 👉 SVIP ürününün Shopier linki
    devami: "MVP",
  ...
  },
  {
    ...
    satinAlLinki: "", // 👉 SPONSOR ürününün Shopier linki
    devami: "SVIP",
    oneCikan: true,
    ayricaliklar: [
      "Ekstra /pv",
...
export const KREDI_PAKETLERI = [
  {
    ...
    bonus: 0,
    fiyat: 50,
    satinAlLinki: "", // 👉 50 kredi ürününün Shopier linkini buraya yapıştır
  },
];
...
export const TESLIMAT = {
  ...
  // Etkinleştirmeden sonra ayrıca çalıştırılacak komutlar (isteğe bağlı)
  ekKomutlar: [],
};
