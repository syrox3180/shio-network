...
export const SUNUCU = {
  ad: "Shio Network",
  kisaAd: "SHIO",
  slogan: "Türkiye'nin GenPvP sunucusu",
  aciklama:
    "Sunucuya katıl, /shop dan gen al ve kasıl.",
...
//   Boxmining ve Prac birbirinden tamamen ayrı sunucular —
//   her birinin kendi RCON bağlantısı var (bkz. lib/rcon.js).
//   Oyuncu sandıkta bir ürünü etkinleştirirken hangi sunucuya
//   gönderileceğini burada tanımlanan id'ler üzerinden seçer.
// -------------------------------------------------------
export const OYUN_MODLARI = [
  { id: "boxmining", ad: "Boxmining" },
  { id: "prac", ad: "Prac" },
];

export function modAdi(id) {
  return OYUN_MODLARI.find((m) => m.id === id)?.ad || id || "—";
}
