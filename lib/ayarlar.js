...
export const SUNUCU = {
  ...
  aciklama:
    "Sunucuya katıl,madenlerini kaz,/warp takas dan onları dönüştür ve maceraya sende katıl.",
...
export const OZELLIKLER = [
  {
    ...
    metin:
      "Özel kılıçlarımız mevcuttur",
  },
  {
    baslik: "Yükseltme sistemi",
    metin:
      "Mağazadan vip alarak yükselebilirsiniz ",
  },
  {
